...
``` r
# Item 2: Creating a numerical vector
int_vect <- 1:9

# Item 3: Creating a vector from letters
char_vect <- LETTERS[1:17]

# Item 4: Finding out how many letters come after the letter "D"
letters_after_D <- which(char_vect > "D")
num_of_items <- length(letters_after_D)
print(num_of_items)
```
